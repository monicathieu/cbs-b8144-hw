...
Each exercise comes with solution output that you can inspect, but the code is hidden so you can write yours on your own. Your code's output should look identical to the solution output, so you can check your work before you finish.
